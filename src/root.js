...
const FormCreatorApp = lazy(() => import("./ui/App/Pages/Form/create/index.tsx"));
const FormsListCustom = lazy(() => import("./ui/App/Pages/Form/FormsListCustom.tsx"));
...
const FormResponses = lazy(() => import("./ui/App/Pages/Form/responses/formResponses.tsx"));
...
import { AppStateProvider, AppWrapper } from "./ui/App/context/appStateContext.tsx";
...
const AppRoutes = () => {
  ...
  return (
    <div
      className={`transition-all duration-300 ease-in-out ${isMobile ? 'px-4' : 'px-8'} ${
    ...
    >
      ...
      <footer className={`hidden mt-16 text-center font-kanit py-8 ${
        isDark ? 'text-zinc-100 bg-zinc-900/50' : 'text-zinc-600 bg-pink-50'
      }`}>
...
const App = () => {
  ...
  return (
    <ConfigProvider theme={getAntdTheme()} locale={enUS}>
      <AppWrapper>
        <div className={`subpixel-antialiased transition-colors duration-300 ${
          isDark
