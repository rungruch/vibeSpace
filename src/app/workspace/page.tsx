    ...
    <main className="min-h-screen p-6 sm:p-12 relative overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors">
      ...
      <div className="relative z-50 w-full mb-8 sm:mb-16 max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 sm:gap-4">
          ...
          {user ? (
            <div className="flex items-center gap-2 sm:gap-4 bg-white/50 dark:bg-slate-900/50 backdrop-blur-md px-2 sm:px-4 py-1 sm:py-2 rounded-full border border-slate-200 dark:border-slate-800 shadow-sm ml-1 sm:ml-0">
              <div className="flex items-center gap-2">
                {user.photoURL ? (
              ...
              <Button variant="ghost" size="icon" onClick={logOut} className="text-slate-500 hover:text-red-500 rounded-full w-8 h-8 sm:w-auto sm:px-2">
